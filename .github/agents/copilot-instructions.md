...
- Python 3.13 / 3.14 (dual target per CI matrix) + Home Assistant ≥ 2025.8.0, icalendar (003-coordinator-migration)
...
## Recent Changes
- 003-coordinator-migration: Added Python 3.13 / 3.14 (dual target per CI matrix) + Home Assistant ≥ 2025.8.0, icalendar
