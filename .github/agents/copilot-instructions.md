...
- Python ≥3.14.2 + Home Assistant ≥2026.4.0, keymaster (HACS integration), icalendar ≥7.0.0 (006-child-lock-monitoring)
- N/A (HA state machine + config entries) (006-child-lock-monitoring)
...
## Recent Changes
- 006-child-lock-monitoring: Added Python ≥3.14.2 + Home Assistant ≥2026.4.0, keymaster (HACS integration), icalendar ≥7.0.0
