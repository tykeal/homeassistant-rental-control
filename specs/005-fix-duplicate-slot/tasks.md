...
- [ ] T003 Add `_lock: asyncio.Lock`, `_retry_counts: dict[int, int]` (default `{}`), `_escalated: dict[int, bool]` (default `{}`), and `_slot_uids: dict[int, str | None]` (default `{}`) fields to `EventOverrides.__init__()` in `custom_components/rental_control/event_overrides.py`
